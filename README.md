...
---
Esto es un archivo README. Debe contener la documentación de soporte uso de la herramienta digital. Es la parte de java del programa ONE-ORACLE GNERACION 6, impartido Alura Latam,
EL curso esta compuesto por 5 cursos con tiempo estimado de trabajo de 46 horas
...
- Consumir API, escribir archivos y manejar errores
